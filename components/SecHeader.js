  ...
  return (
    <View style={styles.header}>
        <View style={{flexDirection: 'row', alignItems: 'center'}}>
          ...
          <Ionicons name="md-chevron-back" style={{marginLeft: '8%'}} size={32} color="blue" />
          </Pressable>
        ...
        <View style={styles.icons}>
            <View style={styles.cart}>
              <Pressable onPress={toCart}>
                <Ionicons name="md-cart" size={32} color="blue" />
              </Pressable>
            ...
            <Pressable onPress={()=>{setIsPopUp(prev=>!prev);logout()}}><Ionicons name="md-ellipsis-vertical" size={32} color="blue" /></Pressable>
